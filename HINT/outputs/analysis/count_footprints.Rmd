...
barplot(df_no_single$Counts, names.arg = df_no_single$Ind, col = colors, main="Motif match counts", legend=c("Flu", "NI"), las=2)

barplot(df_no_single$Mean_Size, names.arg = df_no_single$Ind_p, col = colors, main="Motif match mean size", legend=c("Flu", "NI"), las=2)
...
```{r r Genome-wide NFKB1 Match Counts}
...
barplot(df_no_single$Counts, names.arg = df_no_single$Ind, col = colors, main="NFKB Motif match counts", legend=c("Flu", "NI"), las=2)

barplot(df_no_single$Mean_Size, names.arg = df_no_single$Ind_p, col = colors, main="NFKB Motif match mean size", legend=c("Flu", "NI"), las=2)
